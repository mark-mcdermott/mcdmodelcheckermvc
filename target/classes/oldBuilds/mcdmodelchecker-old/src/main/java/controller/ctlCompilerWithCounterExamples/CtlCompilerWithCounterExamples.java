package controller.ctlCompilerWithCounterExamples;

import controller.ctlCompiler.CtlCompilerBaseVisitor;
import controller.ctlCompiler.CtlCompilerLexer;
import controller.ctlCompiler.CtlCompilerParser;
import controller.dataTypes.ctlHelpers.CounterExample;
import controller.dataTypes.ctlHelpers.CounterExamples;
import controller.dataTypes.ctlHelpers.FormulaType;
import controller.dataTypes.ctlHelpers.StatesThatHoldAndCounterExamples;
...
public class CtlCompilerWithCounterExamples extends CtlCompilerBaseVisitor<StatesThatHoldAndCounterExamples> {
    ...
    public CtlCompilerWithCounterExamples() { }

    public CtlCompilerWithCounterExamples(String model, Kripke kripke, Vertex stateToCheck) {
        this.model = model;
        this.kripke = kripke;
    ...
    @Override public StatesThatHoldAndCounterExamples visitFormula(CtlCompilerParser.FormulaContext ctx) {
        ...
        CtlCompilerParser.FormulaContext formula = ctx;
        try {
    ...
    public static StatesThatHoldAndCounterExamples SAT(CtlCompilerParser.FormulaContext formula, Set set) throws McdException {
        ...
        CtlCompilerParser.FormulaContext Φ1Ctx;
        CtlCompilerParser.FormulaContext Φ2Ctx;
        Set Φ1;
        Set Φ2;
