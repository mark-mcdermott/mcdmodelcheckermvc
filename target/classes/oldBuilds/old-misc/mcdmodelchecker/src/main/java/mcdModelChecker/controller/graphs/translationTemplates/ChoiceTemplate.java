package mcdModelChecker.controller.graphs.translationTemplates;

import mcdModelChecker.controller.graphs.Translate;
import mcdModelChecker.controller.graphs.utils.GraphUtils;
import mcdModelChecker.controller.types.kripke.Label;
import mcdModelChecker.controller.types.kripke.Relation;
import mcdModelChecker.controller.types.translation.TemplateSwapDetails;
...
import static mcdModelChecker.controller.types.vertex.VertexStatus.*;
...
public class ChoiceTemplate {
    ...
    public ChoiceTemplate(Vertex vertexToReplace, VertexList vertexList) {
        ...
        Integer number = new GraphUtils().getHighestVertexNum(vertexList) + 1;
