...
//         return false;
    ...
    public String getShortenedKind() throws ExceptionMessage {
        ...
        switch(kind) {
            ...
            case TRY:
                ...
                break;
            default:
                throw new ExceptionMessage("controller.dataTypes.vertex.Vertex.java " + getLineNumber() + ": kind not recognized as VertexKind const.");
        }
        return kindStrShort;
    }
    ...
    public String getLabelsStr() throws ExceptionMessage {
        String labelsStr = "";
